...
> #### [1. STW Pauses during program runtime ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#1-stw-pauses-during-program-runtime)

> #### [2. STW Pauses during program runtime, group by EventName ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#2-stw-pauses-during-program-runtime-group-by-eventname)

> #### [3. Latency Heatmaps, Linear ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#3-latency-heatmaps-linear)


> #### [4. Logarithmic heatmaps ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#4-logarithmic-heatmaps)


> #### [5. Latency percentiles over time intervals ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#5-latency-percentiles-over-time-intervals)

> #### [6. Sum of pause durations over intervals ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#6-sum-of-pause-durations-over-intervals)

> #### [7. Percentage of heap filled after GC ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#7-percentage-of-heap-filled-after-gc)

> #### [8. Heap Before and After GC ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#8-heap-before-and-after-gc)

> #### [9. MB Reclaimed during program runtime ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#9-mb-reclaimed-during-program-runtime)

> #### [10. Heap allocation rate ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#10-heap-allocation-rate)

> #### [11. Concurrent durations during runtime ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#11-concurrent-durations-during-runtime)

> #### [12. Sum of event durations, grouped by EventType ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#12-sum-of-event-durations-grouped-by-eventtype)
...
> #### [16. Pause frequencies histogram ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#16-pause-frequencies-histogram)

> #### [17. Number of times GC invoked over time intervals ->](https://github.com/apple/GCGC/blob/main/src/notebooks/README.md#17-number-of-times-gc-invoked-over-time-intervals)
