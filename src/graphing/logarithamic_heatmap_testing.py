...
import numpy as np
from src.graphing.binary_search_closest import binary_search
...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
def plot_heatmap_2(heatmap, dimensions, labels=True):
...
def get_heatmap_data_2(timestamp_groups, datapoint_groups, labels, dimensions):
