...
1. First, confirm you have installed Jupyter notebooks using `pip3 install notebook`, as described above.
2. Using a terminal window, navigate to the correct folder that holds your `.ipynb` files, which should be the [notebooks](./src/notebooks) folder in this project.
...
> Note: You can use some IDEs to edit and run your Jupyter-notebook, if desired. One example is VS-Code, which lets you modifiy and run the notebook in the IDE if the server is being hosted. However, all documentation in this project expects you to be using web based Jupyter notebooks